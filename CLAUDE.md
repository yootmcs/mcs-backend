...
## บริบทถาวร (อ่านเพิ่มเมื่อเริ่ม session ใหม่ / ย้ายเครื่อง)
โฟลเดอร์ **`docs/context/`** = สำเนาบันทึกความจำของโปรเจกต์ (อยู่ใน git จึงติดไปทุกเครื่อง). เริ่มงานให้ไล่อ่าน `docs/context/README.md` เพื่อบริบทเชิงลึกของแต่ละโมดูล + การรวมระบบ. คู่มือย้ายข้อมูลข้ามเครื่องอยู่ที่ `../backups/README-คู่มือย้ายข้อมูล.md` (นอก git — มากับไฟล์สำรอง).
